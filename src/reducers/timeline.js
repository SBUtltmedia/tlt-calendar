import { RECEIVE_TIMELINE_ITEMS, ADD_TIMELINE_ITEM, REMOVE_TIMELINE_ITEM, UPDATE_TIMELINE_ITEM, MOVE_TIMELINE_ITEM, RESIZE_TIMELINE_ITEM } from '../constants/ActionTypes';
...
export default function timeline(state=initialState, action) {
  switch (action.type) {
    ...
    case UPDATE_TIMELINE_ITEM:
      return {...state, items: utils.updateItem(state.items, action.itemId, action.newItemData)};
